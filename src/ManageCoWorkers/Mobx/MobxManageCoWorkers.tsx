...
const MobxManageCoWorkers: React.FC = () => {
  const { observableCoWorkerStore } = useStore();

  return (
    <Card>
      <CardHeader title="Mobx Manage CoWorkers" />
      <CardContent>
        <Form
          onSubmit={(values: CoWorker) =>
            observableCoWorkerStore.addCoWorker(values)
          }
        >
...
export default MobxManageCoWorkers;
